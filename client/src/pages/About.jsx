  ...
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center'>
      ...
      <div className='md:w-1/2 md:pl-8'>
        <h1 className='text-3xl font-bold mb-4 text-slate-800'>Welcome to Suman Estate</h1>
        <p className='mb-4 text-slate-700'>
          At Suman Estate, we're more than just a real estate agency; we're your trusted partner in finding the perfect home or renting out your valuable property. Our mission is to provide exceptional service and unparalleled satisfaction to every client.
        </p>
        <p className="mb-4 text-slate-700">
